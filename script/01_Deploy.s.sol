...
contract Deploy is AnvilKeys, BSCAddr, FixedPoint96Helper {
    ...
    function run() broadcastWithPK(anvilPk0) external virtual {
	...
	_WBNB = address(new TestnetERC20("Testnet - WBNB", "WBNB"));
	_USDC = address(new TestnetERC20("Testnet - USDC", "USDC"));
	_WETH = address(new TestnetERC20("Testnet - WETH", "WETH"));
    }
